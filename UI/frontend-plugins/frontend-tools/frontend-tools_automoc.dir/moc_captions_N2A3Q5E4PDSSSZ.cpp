...
void CaptionsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CaptionsDialog *_t = static_cast<CaptionsDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CaptionsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CaptionsDialog.data,
      qt_meta_data_CaptionsDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CaptionsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CaptionsDialog.stringdata0))
        return static_cast<void*>(const_cast< CaptionsDialog*>(this));
